        ...
        {sortedPendingTasks.length === 0 ? (
          <div className={layoutClasses.emptyState}>
            <div className="max-w-xs mx-auto py-6">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Everything's up to date!</h3>
              <p className="text-sm text-gray-500 mb-4">All tasks completed—outstanding job!</p>
